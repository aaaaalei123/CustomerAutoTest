...
public class Login {
	public void PageRun() throws Exception {
		...
		webDriver.findElement(By.cssSelector("input[placeholder='用户名']")).sendKeys("15970771066");
		Thread.sleep(1000);
		  
	    webDriver.findElement(By.cssSelector("input[placeholder='密码']")).sendKeys("qwer123");
	    Thread.sleep(1000);
